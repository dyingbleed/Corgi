...
import com.dyingbleed.corgi.spark.ds.el.IncrementalDataSource
import com.dyingbleed.corgi.spark.core.PartitionStrategy._
...
/**
  ...
  */
private[spark] abstract class IncrementalSplitDataSource extends DataSource with Splitter {
